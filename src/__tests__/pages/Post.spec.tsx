...
const mockedGetByUIDFormattedReturn: Post = {
...
describe('Post', () => {
  ...
  it('should be able to return prismic post document using getStaticProps', async () => {
    ...
    const postReturn = mockedGetByUIDFormattedReturn;
  ...
  it('should be able to render post document info', () => {
    const postProps = mockedGetByUIDFormattedReturn;

    render(<Post post={postProps} timeToRead="4 min" />);
